...
static const COMMAND_LINE_ARGUMENT_A global_cmd_args[] = {
	...
	{ "pcap-file", COMMAND_LINE_VALUE_REQUIRED, "<pcap-file>", NULL, NULL, -1, NULL,
	  "Packet capture file (.pcap)" },
	{ "pcap-play", COMMAND_LINE_VALUE_BOOL, NULL, BoolValueFalse, NULL, -1, NULL,
	  "Play packet capture file" },
	{ "pcap-save", COMMAND_LINE_VALUE_BOOL, NULL, BoolValueFalse, NULL, -1, NULL,
