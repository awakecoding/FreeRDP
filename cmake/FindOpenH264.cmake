...
find_library(OPENH264_STATIC_LIBRARY
	 NAMES libopenh264.a libopenh264.lib
	 PATH_SUFFIXES lib
	 HINTS ${OPENH264_ROOT})
...
if (OPENH264_INCLUDE_DIR AND OPENH264_LIBRARY)
	...
	if(OPENH264_STATIC_LIBRARY)
		set(OPENH264_LIBRARY ${OPENH264_STATIC_LIBRARY})
	...
	set_property(TARGET openh264 PROPERTY IMPORTED_LOCATION ${OPENH264_LIBRARY})
	set_target_properties(openh264 PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
endif (OPENH264_INCLUDE_DIR AND OPENH264_LIBRARY)
